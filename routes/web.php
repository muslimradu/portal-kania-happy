...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('trainings')->name('trainings.')->group(function () {
        ...
        Route::get('/{training:uuid}', [TrainingController::class, 'show'])->name('show');
        Route::patch('/{training:uuid}', [TrainingController::class, 'update'])->name('update');
        Route::delete('/{training:uuid}', [TrainingController::class, 'destroy'])->name('destroy');
        Route::patch('/{uuid}/restore', [TrainingController::class, 'restore'])->name('restore');
    });

    // Training Participants
    Route::prefix('training-participants')->name('training-participants.')->group(function () {
        Route::get('/', [TrainingParticipantController::class, 'index'])->name('index');
        Route::get('/export/participants', [TrainingParticipantController::class, 'exportParticipants'])->name('export.participants');
        Route::get('/export/payments', [TrainingParticipantController::class, 'exportPayments'])->name('export.payments');
        Route::post('/', [TrainingParticipantController::class, 'store'])->name('store');
        Route::get('/{trainingParticipant:uuid}', [TrainingParticipantController::class, 'show'])->name('show');
        Route::post('/{trainingParticipant:uuid}/pay', [TrainingParticipantController::class, 'pay'])->name('pay');
        Route::delete('/{trainingParticipant:uuid}', [TrainingParticipantController::class, 'destroy'])->name('destroy');
        Route::patch('/{uuid}/restore', [TrainingParticipantController::class, 'restore'])->name('restore');
    });
});
